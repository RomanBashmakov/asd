...
void HI3220_softwareReset(THI3220 *hi, uint16_t mode)
{
    ...
    // while ( HAL_GPIO_ReadPin(hi->pGPIO->PORT_int, hi->pGPIO->PIN_int) ==
    // GPIO_PIN_RESET );
}
...
//===================================================================================
void HI3220_readFIFO(THI3220 *hi, unsigned short FIFOChan,
                     unsigned char *bufferRX, unsigned short count)
{
    uint8_t txData[4];
    uint8_t rxData[4];
...
//===================================================================================
void HI3220_transmitDirect(THI3220 *hi, unsigned short chan, u8_t *pAW_buf,
...
////===================================================================================
// void HI3220_transmitDirect_ZH_LV (THI3220 *hi, unsigned short chan, unsigned
// char *bufferTX, unsigned short msgCount)
//{
//   u8_t cmd = TX0_TTT + chan;
//
//   HI_SPI_CS_DWN;
...
//
//   //  HAL_SPI_Transmit(hi->phspi, bufferTX, msgCount << 2, 100);   //
//   bytesCount = msgCount * 4
//
//   HI_SPI_CS_UP;
//
//   HI_RUN_UP;
...
//===================================================================================
void HI3220_transmitDirect_ZH(THI3220 *hi, unsigned short chan,
                              unsigned char *bufferTX, unsigned short msgCount)
{
    uint8_t txData[4];
    uint8_t rxData[4];
    ...
    HAL_SPI_Transmit(hi->phspi, bufferTX, msgCount << 2,
                     100);  // bytesCount = msgCount * 4

    HAL_GPIO_WritePin(hi->pGPIO->PORT_cs, hi->pGPIO->PIN_cs, GPIO_PIN_SET);
}

//===================================================================================
void HI3220_transmitDirectDMA(THI3220 *hi, unsigned char *bufferTX,
